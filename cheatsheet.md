...
|  2. | List length | len() | .length | same as Java | .size() | same as Java | same as Py3 | .Count | .count |
...
|  12. | Substring | s[i:i+k] | s.substring(i,i+k) | same as Java | s.substr(i,k) | same as Java | same as Py3 |
