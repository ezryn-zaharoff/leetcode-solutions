...
|  10. | New array | ans = [] | int[] ans = new int[2] | let ans = [] | `vector<int> ans` | `var ans = new Array[Int](2) or var ans = Array.fill(n)(0L) or var ans = HashSet[Int]()` | ans := []int{} or make([]int, 2) | int[] ans = new int[n] | `var ans = [Int]() or var ans = Array(repeating: 0, count: n)` |
